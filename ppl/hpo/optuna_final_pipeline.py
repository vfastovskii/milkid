...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--search-space",
        default="ppl/config/experiment_configs/optuna_search_space_bace809_cluster_hier_mha.yaml",
    )
    parser.add_argument(
        "--base-config",
        default="ppl/config/experiment_configs/run_config.yaml",
    )
